  ...
  useEffect(() => {
    const handleParallax = () => {
      ...
      if (rect.top < windowHeight && rect.bottom > 0) {
        ...
        // Smooth, small movement range (-4% to +4%)
        const translateY = (progress - 0.5) * 8;

        // Apply translate only when in view
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center px-6 sm:px-10">
        <h1 className="text-white text-center font-medium leading-snug max-w-5xl
                       text-xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl">
          "Unlock the power of intelligence at your fingertips — where
          innovation meets insight, and your ideas become reality with every
          interaction."
        </h1>
      </div>
    </section>
