...
const ContactArea = () => {
  return (
    <div className="min-h-screen bg-[#f7b518]/10 flex items-center justify-center py-12">
      <Head>
      ...
      <div className="flex flex-col lg:flex-row max-w-6xl w-full gap-6">
        ...
        <div className="lg:w-2/3 p-12 bg-white shadow-lg rounded-lg">
          <h1 className="text-4xl font-serif text-[#333] mb-8">Contact Us</h1>
          ...
          <form>
            ...
            <button
              type="submit"
              className="px-8 py-3 bg-[#4a4a4a] text-white rounded-md hover:bg-[#333] focus:outline-none focus:ring-2 focus:ring-[#f7b518]/20 focus:ring-offset-2"
            >
              Send Message
            </button>
          </form>
        ...
        <div className="lg:w-1/3 flex flex-col gap-6 p-4">
          ...
          {/* Map Section */}
          <div className="relative w-full h-64 flex-grow rounded-lg overflow-hidden">
            <iframe
