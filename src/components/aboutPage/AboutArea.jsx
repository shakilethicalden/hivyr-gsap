    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-start justify-between">
        ...
        <div className="lg:w-1/2 flex flex-col gap-10">
          ...
          {/* Second Paragraph */}
          <p className="paragraph_text text-gray-500">
            Today, we turn that vision into reality by building intelligent solutions that streamline operations, enhance customer experiences, and drive smarter decision-making. From automation to data-driven insights, our focus is on delivering AI that is not only powerful but also intuitive and scalable — empowering businesses to grow, adapt, and lead in an ever-evolving digital world.
          </p>
          ...
          <div className="w-full border-t border-gray-200 mt-4">
            ...
            {/* Header */}
            <div className="grid grid-cols-3 text-[16px] md:text-[18px] uppercase tracking-wider  py-4">
              <span>Metric</span>
              <span>Value</span>
            ...
            {/* Row 1 */}
            <div className="grid grid-cols-3 items-center py-4 border-t border-gray-100 text-[16px] md:text-[18px]">
